...
const Homepage2 = () => {
    ...
    return (
        <div className="bg-white overflow-hidden">
            <style>{`
                /* Override gnathos-primary color with #089970 */
                .bg-gnathos-primary { background-color: #089970 !important; }
                .bg-gnathos-primary\\/10 { background-color: rgba(8, 153, 112, 0.1) !important; }
                .bg-gnathos-primary\\/20 { background-color: rgba(8, 153, 112, 0.2) !important; }
                .bg-gnathos-primary\\/5 { background-color: rgba(8, 153, 112, 0.05) !important; }
                .bg-gnathos-primary\\/95 { background-color: rgba(8, 153, 112, 0.95) !important; }
                .bg-gnathos-primary\\/70 { background-color: rgba(8, 153, 112, 0.7) !important; }
                .bg-gnathos-primary\\/30 { background-color: rgba(8, 153, 112, 0.3) !important; }
                .text-gnathos-primary { color: #089970 !important; }
                .fill-gnathos-primary { fill: #089970 !important; }
                .border-gnathos-primary { border-color: #089970 !important; }
                .from-gnathos-primary { --tw-gradient-from: #089970 !important; }
                .to-gnathos-primary { --tw-gradient-to: #089970 !important; }
                .hover\\:bg-gnathos-primary\\/20:hover { background-color: rgba(8, 153, 112, 0.2) !important; }
                .hover\\:border-gnathos-primary:hover { border-color: #089970 !important; }
                .hover\\:text-gnathos-primary:hover { color: #089970 !important; }
                .group-hover\\:text-gnathos-primary:hover { color: #089970 !important; }
            `}</style>
            <SEO
                ...
                <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                    ...
                    >
                        ...
                        >
                            ...
                            <a href="https://wa.me/919900666476?text=Hi%2C%20I%20would%20like%20to%20schedule%20a%20virtual%20consultation" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
            ...
            <div className="bg-gnathos-primary py-2 sm:py-3 overflow-hidden relative">
                ...
                <div className="flex whitespace-nowrap relative">
                    <motion.div
                        className="flex gap-4 sm:gap-8 items-center flex-shrink-0"
                        initial={{ x: "0%" }}
                        animate={{ x: "-50%" }}
                        transition={{
                            repeat: Infinity,
                    ...
                    >
                        ...
                        {[...Array(8)].map((_, i) => (
                            <div key={`first-${i}`} className="flex items-center gap-4 sm:gap-8 text-white font-bold text-sm sm:text-base lg:text-lg uppercase tracking-wider">
                        ...
                        {[...Array(8)].map((_, i) => (
                            <div key={`second-${i}`} className="flex items-center gap-4 sm:gap-8 text-white font-bold text-sm sm:text-base lg:text-lg uppercase tracking-wider">
                                <span>1000+ Happy Patients</span>
                                <span className="text-white">•</span>
                                <span>15+ Years Experience</span>
                                <span className="text-white">•</span>
            ...
            {/* Technology */}
            <section className="py-10 sm:py-12 md:py-16 overflow-hidden bg-white">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                    <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20 items-center">
                        ...
                        >
                            <div className="relative rounded-2xl sm:rounded-[2rem] overflow-hidden shadow-2xl h-[300px] sm:h-[350px] lg:h-[500px]">
            ...
            <section className="py-10 sm:py-12 md:py-16 bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
                    ...
                    <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
                        ...
                        <motion.div
                            ...
                            className="group"
                        >
                            <div className="relative h-[380px] sm:h-[400px] rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                                {/* Background Image */}
                                <img
                                    src="/GNA Dental/homepage2/Cosmetic Dentistry.jpg"
                                    alt="Cosmetic Dentistry"
                                    className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                                />

                                {/* Gradient Overlay - Always visible but changes on hover */}
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-black/20 group-hover:from-gnathos-primary/95 group-hover:via-gnathos-primary/70 group-hover:to-gnathos-primary/30 transition-all duration-500"></div>

                                {/* Content */}
                                <div className="absolute inset-0 p-6 sm:p-8 flex flex-col justify-end">
                                    {/* Icon - Moves up on hover */}
                                    <img
                                        src="/GNA Dental/homepage2/teeth_icon.png"
                                        alt="Cosmetic Dentistry Icon"
                                        className="w-12 h-12 mb-4 transform group-hover:scale-110 transition-transform duration-300 filter brightness-0 invert"
                                    />
                                    ...
                                    {/* Decorative Line */}
                                    <div className="w-16 h-1 bg-white/80 mb-4 rounded-full group-hover:w-24 transition-all duration-500"></div>
                                    ...
                                    <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                                        <Link to="/contact">
                                            <Button className="bg-white text-gnathos-primary hover:bg-gray-100 font-bold rounded-full text-sm px-6">
                                                Book Consulting
                                            </Button>
                                        </Link>
                                    </div>
                        ...
                        >
                            <div className="relative h-[380px] sm:h-[400px] rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                                {/* Background Image */}
                                <img
                                    src="/GNA Dental/homepage2/General Dentistry.jpg"
                                    alt="General Dentistry"
                                    className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                                />

                                {/* Gradient Overlay */}
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-black/20 group-hover:from-teal-600/95 group-hover:via-teal-600/70 group-hover:to-teal-600/30 transition-all duration-500"></div>
                                ...
                                <div className="absolute inset-0 p-6 sm:p-8 flex flex-col justify-end">
                                    ...
                                    <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                                        <Link to="/contact">
                                            <Button className="bg-white text-teal-600 hover:bg-gray-100 font-bold rounded-full text-sm px-6">
                                                Book Consulting
                                            </Button>
                                        </Link>
                                    </div>
                        ...
                        >
                            <div className="relative h-[380px] sm:h-[400px] rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                                {/* Background Image */}
                                <img
                                    src="/GNA Dental/homepage2/oral surgery.jpg"
                                    alt="Oral Surgery"
                                    className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                                />

                                {/* Gradient Overlay */}
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-black/20 group-hover:from-cyan-600/95 group-hover:via-cyan-600/70 group-hover:to-cyan-600/30 transition-all duration-500"></div>
                                ...
                                <div className="absolute inset-0 p-6 sm:p-8 flex flex-col justify-end">
                                    ...
                                    <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                                        <Link to="/contact">
                                            <Button className="bg-white text-cyan-600 hover:bg-gray-100 font-bold rounded-full text-sm px-6">
                                                Book Consulting
                                            </Button>
                                        </Link>
                                    </div>
            ...
            {/* Meet Our Team */}
            <section className="py-10 sm:py-12 md:py-16 bg-gradient-to-br from-white via-gray-50 to-teal-50/20 relative overflow-hidden">
                {/* Decorative Elements */}
                    ...
                    <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
                        ...
                        >
                            <div className="relative rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 h-[450px] border border-gray-100 hover:-translate-y-2">
                                {/* Background Image */}
                                <img
                                    src="GNA Dental/homepage2/Dr-Pratyusha_.jpg"
                                    alt="Dr. Pratyusha"
                                    className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                                />
            ...
            <section className="py-10 sm:py-12 md:py-16 bg-gradient-to-br from-gray-50 via-white to-teal-50/20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                    <div className="text-center mb-12 sm:mb-16">
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                        ...
                        >
                            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl border-4 sm:border-8 border-gnathos-primary/20 group h-[400px] sm:h-[500px] lg:h-[600px]">
                                <img
                                    src="/GNA Dental/homepage2/why.png"
            ...
            <section className="py-8 sm:py-10 md:py-12 bg-gradient-to-br from-teal-50/30 via-white to-gray-50 relative overflow-hidden">
                {/* Decorative elements */}
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    >
                        ...
                        <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gnathos-primary to-teal-600 mb-3 px-4 leading-tight pb-1">
                            Best Dental Clinic in Hyderabad
                        </h3>
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-2 mb-1">
                            <Award className="w-5 sm:w-6 h-5 sm:h-6 text-gnathos-primary" />
                            <p className="text-base sm:text-lg md:text-xl font-bold text-gray-900 text-center px-4">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 mb-8 sm:mb-10 px-4"
                    >
                        {/* Lifetime Warranty */}
                        <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white rounded-full px-4 sm:px-6 py-2 sm:py-3 flex items-center gap-2 sm:gap-3 shadow-xl border-2 border-gnathos-primary/20 hover:scale-105 transition-transform w-full sm:w-auto max-w-xs">
                            <div className="w-10 sm:w-12 h-10 sm:h-12 bg-gnathos-primary rounded-full flex items-center justify-center flex-shrink-0">
                                <Award className="w-5 sm:w-6 h-5 sm:h-6 text-white" />
                            </div>
                            <div className="text-left">
                                <p className="text-base sm:text-lg font-bold">Lifetime Warranty</p>
                                <p className="text-[10px] sm:text-xs text-gray-300">On All Treatments</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white rounded-full px-4 sm:px-6 py-2 sm:py-3 flex items-center gap-2 sm:gap-3 shadow-xl border-2 border-gnathos-primary/20 hover:scale-105 transition-transform w-full sm:w-auto max-w-xs">
                            ...
                            <div className="text-left">
                                <p className="text-base sm:text-lg font-bold">Lowest Price</p>
                                <p className="text-[10px] sm:text-xs text-gray-300">Guaranteed</p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
                            ...
                            <div className="text-center">
                                ...
                                <h4 className="font-bold text-gray-900 text-[10px] sm:text-xs mb-0.5">Excellence Summit</h4>
                                <p className="text-[9px] sm:text-[10px] text-gray-600">Forbes India</p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <h4 className="font-bold text-gray-900 text-[10px] sm:text-xs mb-0.5">Asia Healthcare</h4>
                                <p className="text-[9px] sm:text-[10px] text-gray-600">Award</p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <h4 className="font-bold text-gray-900 text-[10px] sm:text-xs mb-0.5">International</h4>
                                <p className="text-[9px] sm:text-[10px] text-gray-600">Business Award</p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <h4 className="font-bold text-gray-900 text-[10px] sm:text-xs mb-0.5">International</h4>
                                <p className="text-[9px] sm:text-[10px] text-gray-600">Excellence Award</p>
                            </div>
                        </div>
                    </motion.div>
 ...
 */}
            ...
            {/* Booking Banner */}
            <section className="py-12 sm:py-14 md:py-16 bg-gnathos-primary text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                    <div className="relative h-[500px] sm:h-[600px] overflow-hidden rounded-2xl sm:rounded-3xl group">
                        ...
                        <div className="absolute inset-0">
                            <img
                                src="GNA Dental/homepage2/hm.png"
